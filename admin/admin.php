            ...
            <tbody>
                <?php
                    ...
                    while($rows = mysqli_fetch_assoc($result)){
                        ...
                        <td><a href='edit.php?id=$rows[id]&role=promotion'><i class='fas fa-trash-alt'></i></a></td>
                        </tr>";
                    }
                ?>
            </tbody>
            ...
            <tbody>
                <?php
                    ...
                    while($rows = mysqli_fetch_assoc($result)){
                        ...
                        <td><a href='edit.php?id=$rows[id]&role=discount'><i class='fas fa-trash-alt'></i></a></td>
                        </tr>";
                    }
                ?>
            </tbody>
            ...
            <tbody id="event">
                <?php
                    ...
                    while($rows = mysqli_fetch_assoc($result)){
                        ...
                        <td><a href='edit.php?id=$rows[id]&role=event'><i class='fas fa-trash-alt'></i></a></td>
                        </tr>";
                    }
                ?>
            </tbody>
